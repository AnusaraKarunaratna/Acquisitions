...
const securityMiddleware = async (req, res, next) => {
    try{
        ...
        return res.status(500).json({ error: 'Internal Server Error', details: 'Something went wrong with security middleware.' });
    }
}
